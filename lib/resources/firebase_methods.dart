...
class FirebaseMethods {
  ...
  StorageReference fibaseStorage = FirebaseStorage.instance.ref();
  ...
  Future<void> uploadImage({
    ...
    try {
      StorageReference _storageRef = fibaseStorage.child(
        '${senderId}_${DateTime.now().millisecondsSinceEpoch}',
      );
      await _storageRef.putFile(image).onComplete;
  ...
  Future<void> uploadProfilePic({
    ...
    try {
      StorageReference _storageRef = fibaseStorage.child('profilePic/$uid');
      await _storageRef.putFile(image).onComplete;
      String imageUrl = await _storageRef.getDownloadURL();
